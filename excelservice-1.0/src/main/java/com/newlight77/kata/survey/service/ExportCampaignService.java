...
public class ExportCampaignService {
    ...
    private static final int COLUMN_WIDTH_FIRST = 10500;
    private static final int COLUMN_WIDTH_OTHERS = 6000;
    ...
    public void sendResults(final Campaign campaign, final Survey survey) {
        ...
        sheet.setColumnWidth(0, COLUMN_WIDTH_FIRST);
        for (int i = 1; i <= 18; i++) {
            sheet.setColumnWidth(i, COLUMN_WIDTH_OTHERS);
        }
        ...
        final String clientAddress = survey.getClientAddress().getStreetNumber() + " " + survey.getClientAddress().getStreetName() + survey.getClientAddress().getPostalCode() + " " + survey.getClientAddress().getCity();
